...
export function companyService(db: Db) {
  ...
  function isIssuePrefixConflict(error: unknown) {
    ...
    for (const candidate of candidates) {
      const constraint = typeof candidate === "object" && candidate !== null && "constraint" in candidate
        ? (candidate as { constraint?: string }).constraint
        : typeof candidate === "object" && candidate !== null && "constraint_name" in candidate
    ...
    return message.includes("companies_issue_prefix_idx");
  }
