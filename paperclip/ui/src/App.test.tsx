...
describe("CloudAccessGate", () => {
  ...
  beforeEach(() => {
    ...
    mockFinanceApi.status.mockResolvedValue({
      enabled: false,
  ...
  it("lets Finance Anything users continue while the base instance bootstrap is pending", async () => {
    mockHealthApi.get.mockResolvedValue({
      status: "ok",
      deploymentMode: "authenticated",
    ...
    expect(container.textContent).toContain("Outlet content");
    expect(container.textContent).not.toContain("Instance setup required");
