...
describe("createZipArchive", () => {
  ...
  it("reads a Finance Anything zip archive back into rootPath and file contents", async () => {
    const archive = createZipArchive(
      {
        "COMPANY.md": "# Company\n",
        "agents/ceo/AGENTS.md": "# CEO\n",
  ...
  it("reads standard DEFLATE zip archives created outside Finance Anything", async () => {
