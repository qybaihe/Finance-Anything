...
describe("company-members helpers", () => {
  ...
  it("includes human users in markdown mention options", () => {
    const options = buildMarkdownMentionOptions({
      ...
      projects: [{ id: "project-1", name: "Finance Anything App", color: "#336699" }],
    });
    ...
    expect(options).toEqual([
      ...
      { id: "project:project-1", name: "Finance Anything App", kind: "project", projectId: "project-1", projectColor: "#336699" },
    ]);
  });
