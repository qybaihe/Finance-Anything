...
describe("issue-reference", () => {
  ...
  it("does not treat GitHub issue URLs as internal Finance Anything issue links", () => {
  ...
  it("preserves absolute Finance Anything issue URLs so origin, port, and hash are not lost", () => {
