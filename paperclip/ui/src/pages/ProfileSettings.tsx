...
export function ProfileSettings() {
  ...
  const uploadAvatarMutation = useMutation({
    mutationFn: async (file: File) => {
      if (!selectedCompanyId) {
        throw new Error(t("Select a company to upload an avatar into Finance Anything storage."));
      }
  ...
  const uploadHint = selectedCompany
    ? t("Stored in Finance Anything file storage for {{company}}.", { company: selectedCompany.name })
    : t("Select a company to upload an avatar into Finance Anything storage.");
