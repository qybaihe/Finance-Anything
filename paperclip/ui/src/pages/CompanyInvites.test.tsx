...
vi.mock("@/context/CompanyContext", () => ({
  useCompany: () => ({
    ...
    selectedCompany: { id: "company-1", name: "Finance Anything", issuePrefix: "PAP" },
  }),
}));
...
describe("CompanyInvites", () => {
  ...
  it("renders a human-only invite flow and keeps invite history in a table", async () => {
    ...
    expect(container.textContent).toContain("This URL includes the current Finance Anything domain returned by the server.");
