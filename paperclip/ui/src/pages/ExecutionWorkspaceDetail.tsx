  ...
  const runRoutine = useMutation({
    ...
    onSuccess: async (_, { id }) => {
      ...
      pushToast({
        ...
        body: "Finance Anything created a run using this execution workspace.",
        tone: "success",
      });
    },
    onSettled: () => {
    ...
    onError: (mutationError) => {
      pushToast({
        ...
        body: mutationError instanceof Error ? mutationError.message : "Finance Anything could not start the routine run.",
        tone: "error",
      });
    },
  });
            ...
            <Card className="rounded-none">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <Field label="Provision command" hint="Runs when Finance Anything prepares this execution workspace">
                    <Textarea
