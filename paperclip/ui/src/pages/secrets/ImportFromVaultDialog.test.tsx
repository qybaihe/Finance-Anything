...
describe("ImportFromVaultDialog", () => {
  ...
  it("blocks import when a review row collides with an existing Finance Anything secret", async () => {
  ...
  it("renders sanitized preview provider errors without raw AWS exception text", async () => {
    const rawProviderMessage =
      "AccessDeniedException: User: arn:aws:sts::123456789012:assumed-role/prod/Finance Anything is not authorized";
