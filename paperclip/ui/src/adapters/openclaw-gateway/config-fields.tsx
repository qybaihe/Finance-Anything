...
export function OpenClawGatewayConfigFields({
  ...
  return (
    <>
      ...
      {!isCreate && (
        <>
          <Field label="Finance Anything API URL override">
            <DraftInput
              value={
                eff(
                  "adapterConfig",
          ...
          <Field label="Device auth">
            <div className="text-xs text-muted-foreground leading-relaxed">
              Always enabled for gateway agents. Finance Anything persists a device key during onboarding so pairing approvals
