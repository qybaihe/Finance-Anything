...
const mockCompanyState = vi.hoisted(() => ({
  companies: [{ id: "company-1", issuePrefix: "PAP", name: "Finance Anything" }],
  selectedCompany: { id: "company-1", issuePrefix: "PAP", name: "Finance Anything" },
...
describe("Layout", () => {
  ...
  beforeEach(() => {
    ...
    mockCompanyState.companies = [{ id: "company-1", issuePrefix: "PAP", name: "Finance Anything" }];
    mockCompanyState.selectedCompany = { id: "company-1", issuePrefix: "PAP", name: "Finance Anything" };
  ...
  it("uses the route company context for plugin route sidebars on the first render", async () => {
    ...
    mockCompanyState.companies = [
      { id: "company-1", issuePrefix: "PAP", name: "Finance Anything" },
